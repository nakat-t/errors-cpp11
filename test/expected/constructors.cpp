...
TEST_CASE("Constructors", "[constructors]") {
    ...
    {
        errors::expected<int,int> e = errors::make_unexpected(0);
        REQUIRE(!e);
        REQUIRE(e.error() == 0);
    }

    {
        errors::expected<int,int> e (errors::unexpect, 0);
        REQUIRE(!e);
        REQUIRE(e.error() == 0);
    }

    {
        errors::expected<int,int> e (bp11_in_place, 42);
        REQUIRE(e);
        REQUIRE(e == 42);
    }

    {
        errors::expected<std::vector<int>,int> e (bp11_in_place, {0,1});
        REQUIRE(e);
        REQUIRE((*e)[0] == 0);
        REQUIRE((*e)[1] == 1);
    }
    ...
    {
        errors::expected<std::tuple<int,int>,int> e (bp11_in_place, 0, 1);
        REQUIRE(e);
    ...
    {
        errors::expected<takes_init_and_variadic,int> e (bp11_in_place, {0,1}, 2, 3);
        REQUIRE(e);
        REQUIRE(e->v[0] == 0);
        REQUIRE(e->v[1] == 1);
...
#	endif
    ...
    {
        errors::expected<void,int> e;
        REQUIRE(e);
    }

    {
        errors::expected<void,int> e (errors::unexpect, 42);
        REQUIRE(!e);
        REQUIRE(e.error() == 42);
    }
}
